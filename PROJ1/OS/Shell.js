...
(function (TSOS) {
    var Shell = /** @class */ (function () {
        ...
        Shell.prototype.init = function () {
            ...
            // whereAmI
            sc = new ShellCommand(this.shellWhereAmI, "whereAmI", "- displays the users current location.");
            this.commandList[this.commandList.length] = sc;
            //Sky
            sc = new ShellCommand(this.shellSky, "Sky", "- displays the color of the sky.");
            this.commandList[this.commandList.length] = sc;
            // date
            ...
            this.commandList[this.commandList.length] = sc;
            // status <string>
            sc = new ShellCommand(this.shellStatus, "status", "<string> - Displays the status message specified by the user.");
            this.commandList[this.commandList.length] = sc;
            // man <topic>
